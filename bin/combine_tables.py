...
def combine_stat_tables(input_files):
    ...
    combined_tables.columns = ['host_uniquely_mapped','pathogen_uniquely_mapped']
...
combineTables = combine_stat_tables(args.input_files)
