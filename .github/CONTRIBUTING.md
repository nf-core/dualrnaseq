...
For further information/help, please consult the [nf-core/dualrnaseq documentation](https://nf-co.re/nf-core/dualrnaseq/docs) and don't hesitate to get in touch on the nf-core Slack [#dualrnaseq](https://nfcore.slack.com/channels/dualrnaseq) channel ([join our Slack here](https://nf-co.re/join/slack)).
