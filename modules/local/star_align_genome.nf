process STAR_ALIGN {
    ...
    // Note:
    // I've kept the commented out code here for reference
    // As we wanted to have minimal output from STAR, otherwise the folders can get bloated
    // when running multiple alignment/quantification options
