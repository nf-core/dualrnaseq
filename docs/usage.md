...
```bash
nextflow run nf-core/dualrnaseq --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run nf-core/dualrnaseq -profile docker -params-file params.yaml
```
