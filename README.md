...
For more details, please refer to the [usage documentation](https://nf-co.re/dualrnaseq/usage) and the [parameter documentation](https://nf-co.re/dualrnaseq/parameters).

## Pipeline output

To see the the results of a test run with a full size dataset refer to the [results](https://nf-co.re/dualrnaseq/results) tab on the nf-core website pipeline page.
